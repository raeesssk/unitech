// import admin
angular.module('supplierpayment').controller('supplierpaymentListCtrl', function ($rootScope, $http, $scope, $location, $routeParams, $route, $filter) {
