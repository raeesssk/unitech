// import admin
angular.module('supplierpayment').controller('supplierpaymentEditCtrl', function ($rootScope, $http, $scope, $location, $routeParams, $route) {
  ...
  $scope.updateSupplierPayment = function () {
